<template>
  <div class="WrapContent">
    ...
    <div>
      ...
      <button id="submit" @click="updateArticle">发布</button>
  ...
  export default {
    ...
    methods: {
      ...
      upload: function (event) {
        ...
        this.$http.post(`${process.env.API_ROOT}/upload/articleImg`, formData, config).then(response => {
          console.log('上传文章图片：')
          console.log(response.data)
          ...
          console.log('isVedio=' + this.isVedio)
